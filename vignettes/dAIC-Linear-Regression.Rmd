...
* Add detail of block-wise diagonal calculation, i.e. $\boldsymbol{\Delta}$ is block-wise diagonal with $I_B V_B$ in the top left and $I_S V_S$ in the bottom right.
