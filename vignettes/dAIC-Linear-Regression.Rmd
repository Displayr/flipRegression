...
\begin{aligned}
    \ell(\boldsymbol{\theta}) &= \log L(\boldsymbol{\theta} \mid \boldsymbol{Y}, \boldsymbol{X}) = - \frac{n}{2} \log(2 \pi) - \frac{n}{2} \log(\sigma^2) - \frac{(\boldsymbol{Y} - \boldsymbol{X}\boldsymbol{\beta})^T(\boldsymbol{Y} - \boldsymbol{X}\boldsymbol{\beta})}{2\sigma^2}
        &=: l^{[1]} + l^{[2]} + l^{[3]}
\end{aligned}
...
\begin{aligned}
    \mathcal{H}(\boldsymbol{\theta}) &= \begin{pmatrix} \frac{\partial^2 \ell}{\partial \boldsymbol{\beta} \partial \boldsymbol{\beta}^T} & \frac{\partial^2 \ell}{\partial \boldsymbol{\beta} \partial \sigma^2} \\ \frac{\partial^2 \ell}{\partial \sigma^2 \partial \boldsymbol{\beta}^T} & \frac{\partial^2 \ell}{\partial \sigma^2 \partial \sigma^2} \end{pmatrix}\\
        ...
        \frac{\partial^2\ell}{\partial\sigma^2\partial\sigma^2} &= -\frac{1}{2\sigma^2} \frac{\partial}{\partial\sigma^2} (n - \boldsymbol{\varepsilon}^T \boldsymbol{\varepsilon} / \sigma^2) = \frac{n}{2(\sigma^2)^2} - \frac{\boldsymbol{\varepsilon}^T\boldsymbol{\varepsilon}}{(\sigma^2)^3}
\end{aligned}
...
Leveraging the earlier results from the unweighted likelihood, the likelihood takes the form,
...
\[
    \widehat V_{\sigma^2} = \left(\mathbb{V}\text{ar} U_{\sigma^2}\right)^{-1}.
\]
